...
def main(def_args=sys.argv[1:]):
    ...
    if repository is not None:
        run(['git', 'remote', 'add', 'origin', "https://github.com/bugsCreator/commiter.git"])
        run(['git', 'branch', '-M', 'main'])

        run(['git ', 'commit', '-m', f'COMMENT TO DESCRIBE THE INTENTION OF THE COMMIT {randint(0, 10000)}'])
...
if __name__ == "__main__":
    main()
"""
 --repository=git@github.com:bugsCreator/https://github.com/bugsCreator/commiter.git
"""
